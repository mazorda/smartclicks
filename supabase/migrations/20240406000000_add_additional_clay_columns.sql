/*
This migration adds dedicated columns for Clay.com enrichment data.
The data flow works as follows:

1. Clay webhook sends data to Edge Function
2. Raw data is stored in clay_data JSONB column
3. Trigger (extract_clay_data) automatically populates these columns

Note: Clay sends field names with capital letters (e.g., "Country" not "country").
The trigger handles both cases for compatibility.

Example Clay payload:
{

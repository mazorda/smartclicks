        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-blue-50 rounded-xl p-8 text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">Is your budget being spent wisely?</h3>
            ...
            <div className="bg-blue-50 rounded-xl p-8 text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">Missing high-intent customers?</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-blue-50 rounded-xl p-8 text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">Full visibility into performance?</h3>
              <p className="text-gray-600">
          ...
          <div className="mt-12 p-6 bg-gray-50 rounded-xl border border-gray-200">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-center md:text-left">
                <h4 className="text-2xl font-bold mb-2">The Average Google Ads Account Wastes 76% of Its Budget</h4>
                <p className="text-gray-600">
              ...
              <div className="shrink-0">
                <div className="w-32 h-32 rounded-full bg-blue-100 flex items-center justify-center">
                  <span className="text-4xl font-bold text-blue-600">76%</span>
                </div>
              </div>
            </div>
          </div>
